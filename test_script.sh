...
qm_sendline "uci set network.br-lan=interface"
qm_sendline "uci set network.br-lan.type=bridge"
qm_sendline "uci set network.br-lan.ifname='eth1 eth2 eth3'"
qm_sendline "uci set network.br-lan.proto=static"
qm_sendline "uci set network.br-lan.ipaddr=192.168.2.1"
qm_sendline "uci set network.br-lan.netmask=255.255.255.0"
qm_sendline "uci set dhcp.lan.interface=br-lan"
...
qm_sendline "uci set wireless.default_radio0.network=br-lan"
